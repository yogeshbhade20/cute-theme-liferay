<div class="mx-1 mx-sm-3 order-md-1 cute-user">
    <@liferay.user_personal_bar />
</div>

<div class="collapse navbar-collapse" id="cuteNav">
    <nav class="${nav_css_class}" id="navigation" rolw="navigation">
            ...
            <#list nav_items as nav_item>
                ...
                <li class="${nav_item_css_class}" id="layout_${nav_item.getLayoutId()}" role="presentation">
                    <a aria-labelledby="layout_${nav_item.getLayoutId()}"
                        class="nav_link" ${nav_item_attr_has_popup} href="${nav_item.getURL()}" ${nav_item.getTarget()} role="menuitem">
                        <span> 
                            <@liferay_theme["layout-icon"] layout=nav_item_lauout />
                        </span>
                        ${nav_item_caret}
                    </a>
                    ...
                    <#if nav_item.hasChildren()>
                        <ul class="child-menu dropdown-menu" role="menu">
                            <#list nav_item.getChildren() as nav_child>
                                ...
                                <li class="${nav_item_css_class}" id="layout_${nav_item.getLayoutId()}" role="presentation">
                                    <a aria-labelledby="layout_${nav_item.getLayoutId()}"
                                        class="nav_link" href="${nav_item.getURL()}" ${nav_item.getTarget()} role="menuitem">${nav_child.getname()}</a>
                                    </a>
                                </li>
                            </#list>
                        </ul>
    ...
    <a aria-control="book-now" class="btn text-white btn-orange order-md-2">
